...
app.post("/mintNFT", async (req, res) => {
  ...
  let txReceipt;
  try {
      txReceipt = await (await beGreen.safeMint(address,"https://silver-sound-gamefowl-947.mypinata.cloud/ipfs/QmS1xfi6s5c5xLM2PqX7xqScmtT41QKfEXty6ygR9kLhNj")).wait(2);
  } catch (error) {
      console.log(error);
  }
